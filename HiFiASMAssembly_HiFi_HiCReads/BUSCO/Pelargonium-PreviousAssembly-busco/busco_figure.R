...
my_species <- c('Pelargonium-PreviousAssembly-busco', 'Pelargonium-PreviousAssembly-busco', 'Pelargonium-PreviousAssembly-busco', 'Pelargonium-PreviousAssembly-busco')
...
my_percentage <- c(81.3, 12.5, 0.9, 5.3)
my_values <- c(1892, 291, 21, 122)
